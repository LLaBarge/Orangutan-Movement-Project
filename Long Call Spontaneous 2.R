...
# create monthly long call occurrence distributions 
# download previously month-separated data from movebank and fit movement models and ODs


LongCalls_Monthly<-getMovebankData(study="Long Call Locations per Month, Tuanan Bornean Orangutans", login=login)
LC_Monthly_tel<- as.telemetry(LongCalls_Monthly, projection = "+init=epsg:32750 +proj=utm +zone=50 +south")


LC.FIT <- list()
for(i in 1:length(LC_Monthly_tel)){
  print(i)
  LC.GUESS <- ctmm.guess(LC_Monthly_tel[[i]], interactive=FALSE)
  LC.FIT[[i]] <- ctmm.select(LC_Monthly_tel[[i]],LC.GUESS, verbose=TRUE,trace=2)
}

names(LC.FIT) <- names(LC_Monthly_tel)

LC_Monthly <- list()
for(i in 1:length(LC_Monthly_tel)){
print(i)
LC_Monthly[[i]] <- occurrence(LC_Monthly_tel[[i]],LC.FIT[[i]][[1]])}
names(LC_Monthly) <- names(LC_Monthly_tel)
View(LC_Monthly)
# occurrence distributions - creating each separately
# because loop failed and created only 13

Chili.08<-occurrence(LC_Monthly_tel$Chili.08,LC.FIT[["Chili.08"]])
Chili.09<-occurrence(LC_Monthly_tel$Chili.09,LC.FIT[["Chili.09"]])
Chili.10<-occurrence(LC_Monthly_tel$Chili.10,LC.FIT[["Chili.10"]])
Chili.11<-occurrence(LC_Monthly_tel$Chili.10,LC.FIT[["Chili.11"]])
Chili.12<-occurrence(LC_Monthly_tel$Chili.10,LC.FIT[["Chili.12"]])
Henk.03<-occurrence(LC_Monthly_tel$Henk.03,LC.FIT[["Henk.03"]])
Henk.10<-occurrence(LC_Monthly_tel$Henk.10,LC.FIT[["Henk.10"]])
Henk.12<-occurrence(LC_Monthly_tel$Henk.12,LC.FIT[["Henk.12"]])
Niko.03<-occurrence(LC_Monthly_tel$Niko.03,LC.FIT[["Niko.03"]])
Niko.05<-occurrence(LC_Monthly_tel$Niko.05,LC.FIT[["Niko.05"]])
Niko.06<-occurrence(LC_Monthly_tel$Niko.06,LC.FIT[["Niko.06"]])
Niko.08<-occurrence(LC_Monthly_tel$Niko.08,LC.FIT[["Niko.06"]])
#Niko.10<-occurrence(LC_Monthly_tel$Niko.10,LC.FIT[["Niko.10"]])
# Niko 10 did not work - not enough data that month

Niko.11<-occurrence(LC_Monthly_tel$Niko.11,LC.FIT[["Niko.11"]])
Niko.12<-occurrence(LC_Monthly_tel$Niko.12,LC.FIT[["Niko.12"]])
Teju.04<-occurrence(LC_Monthly_tel$Teju.04,LC.FIT[["Teju.04"]])
Teju.08<-occurrence(LC_Monthly_tel$Teju.08,LC.FIT[["Teju.08"]])
Teju.09<-occurrence(LC_Monthly_tel$Teju.09,LC.FIT[["Teju.09"]])
Teju.10<-occurrence(LC_Monthly_tel$Teju.10,LC.FIT[["Teju.10"]])
Teju.11<-occurrence(LC_Monthly_tel$Teju.11,LC.FIT[["Teju.11"]])
Teju.12<-occurrence(LC_Monthly_tel$Teju.12,LC.FIT[["Teju.12"]])
Tomi.03<-occurrence(LC_Monthly_tel$Tomi.03,LC.FIT[["Tomi.03"]])
Tomi.04<-occurrence(LC_Monthly_tel$Tomi.04,LC.FIT[["Tomi.04"]])
Tomi.05<-occurrence(LC_Monthly_tel$Tomi.04,LC.FIT[["Tomi.05"]])
Tomi.06<-occurrence(LC_Monthly_tel$Tomi.04,LC.FIT[["Tomi.06"]])
#Tomi.07<-occurrence(LC_Monthly_tel$Tomi.04,LC.FIT[["Tomi.07"]])
#Tomi07 doesnt work

# create rasters of each of these
library(spatialEco)
Chili_08_LC<-raster(Chili.08 , DF="PDF")
Chili_08_LC<-raster.transformation(Chili_08_LC, trans = "norm", smin = 0, smax = 1)
Chili_09_LC<-raster(Chili.09 , DF="PDF")
Chili_09_LC<-raster.transformation(Chili_09_LC, trans = "norm", smin = 0, smax = 1)
Chili_10_LC<-raster(Chili.10 , DF="PDF")
Chili_10_LC<-raster.transformation(Chili_10_LC, trans = "norm", smin = 0, smax = 1)
Chili_11_LC<-raster(Chili.11 , DF="PDF")
Chili_11_LC<-raster.transformation(Chili_11_LC, trans = "norm", smin = 0, smax = 1)
Chili_12_LC<-raster(Chili.12 , DF="PDF")
Chili_12_LC<-raster.transformation(Chili_12_LC, trans = "norm", smin = 0, smax = 1)

Henk_03_LC<-raster(Henk.03 , DF="PDF")
Henk_03_LC<-raster.transformation(Henk_03_LC, trans = "norm", smin = 0, smax = 1)
Henk_10_LC<-raster(Henk.10 , DF="PDF")
Henk_10_LC<-raster.transformation(Henk_10_LC, trans = "norm", smin = 0, smax = 1)
Henk_12_LC<-raster(Henk.12 , DF="PDF")
Henk_12_LC<-raster.transformation(Henk_12_LC, trans = "norm", smin = 0, smax = 1)

Niko_03_LC<-raster(Niko.03 , DF="PDF")
Niko_03_LC<-raster.transformation(Niko_03_LC, trans = "norm", smin = 0, smax = 1)
Niko_05_LC<-raster(Niko.05 , DF="PDF")
Niko_05_LC<-raster.transformation(Niko_05_LC, trans = "norm", smin = 0, smax = 1)
Niko_06_LC<-raster(Niko.06 , DF="PDF")
Niko_06_LC<-raster.transformation(Niko_06_LC, trans = "norm", smin = 0, smax = 1)
Niko_08_LC<-raster(Niko.08 , DF="PDF")
Niko_08_LC<-raster.transformation(Niko_08_LC, trans = "norm", smin = 0, smax = 1)
Niko_11_LC<-raster(Niko.11 , DF="PDF")
Niko_11_LC<-raster.transformation(Niko_11_LC, trans = "norm", smin = 0, smax = 1)
Niko_12_LC<-raster(Niko.12 , DF="PDF")
Niko_12_LC<-raster.transformation(Niko_12_LC, trans = "norm", smin = 0, smax = 1)

Teju_04_LC<-raster(Teju.04 , DF="PDF")
Teju_04_LC<-raster.transformation(Teju_04_LC, trans = "norm", smin = 0, smax = 1)
Teju_08_LC<-raster(Teju.08 , DF="PDF")
Teju_08_LC<-raster.transformation(Teju_08_LC, trans = "norm", smin = 0, smax = 1)
Teju_09_LC<-raster(Teju.09 , DF="PDF")
Teju_09_LC<-raster.transformation(Teju_09_LC, trans = "norm", smin = 0, smax = 1)
Teju_10_LC<-raster(Teju.10 , DF="PDF")
Teju_10_LC<-raster.transformation(Teju_10_LC, trans = "norm", smin = 0, smax = 1)
Teju_11_LC<-raster(Teju.11 , DF="PDF")
Teju_11_LC<-raster.transformation(Teju_11_LC, trans = "norm", smin = 0, smax = 1)
Teju_12_LC<-raster(Teju.12 , DF="PDF")
Teju_12_LC<-raster.transformation(Teju_12_LC, trans = "norm", smin = 0, smax = 1)

Tomi_03_LC<-raster(Tomi.03 , DF="PDF")
Tomi_03_LC<-raster.transformation(Tomi_03_LC, trans = "norm", smin = 0, smax = 1)
Tomi_04_LC<-raster(Tomi.04 , DF="PDF")
Tomi_04_LC<-raster.transformation(Tomi_04_LC, trans = "norm", smin = 0, smax = 1)
Tomi_05_LC<-raster(Tomi.05 , DF="PDF")
Tomi_05_LC<-raster.transformation(Tomi_05_LC, trans = "norm", smin = 0, smax = 1)
Tomi_06_LC<-raster(Tomi.06 , DF="PDF")
Tomi_06_LC<-raster.transformation(Tomi_06_LC, trans = "norm", smin = 0, smax = 1)
